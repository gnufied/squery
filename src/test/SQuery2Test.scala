...
import com.novocode.squery.{Table, Join, Query, ColumnOp, QueryInvoker, Projection}
import com.novocode.squery.sql.{QueryBuilder, InsertUpdateBuilder, DDLBuilder}
...
object SQuery2Test {
  def main(args: Array[String]) {
    ...
    val q1b = QueryInvoker(q1).mapResult { case (id,f,l) => id + ". " + f + " " + l }
